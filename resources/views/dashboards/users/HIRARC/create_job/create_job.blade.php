                            ...
                            <table id="m" class="table table-hover  align-middle mb-0"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <img height="50px" width="40px" src="{{asset('/image/jobimage/' . $value->image)}}" alt="not found"></td>

                                        
                                        
                                    <td>
                                            <a href="{{route('c_job.edit',$value->id)}}" class="icofont-edit" > <i class=""></i></a>||

                                            <a href="{{route('c_job.destroy',$value->id)}}" class="btn btn-danger btn-xs" > <i class="icofont-delete-alt"></i></a>
