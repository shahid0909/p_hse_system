$(document).ready(function() {
    var e="#5A8DEE", t=[e, "#FDAC41", "#FF5B5C", "#39DA8A", "#00CFDD"], a= {
        chart: {
        ...
        , series:[ {
            ...
            text: "Product Trends by Month", align: "left"
        }
        , grid: {
            row: {
                colors: ["#f3f3f3", "transparent"], opacity: .5
            }
        }
        , xaxis: {
    ...
    var n= {
        ...
        , xaxis: {
            type: "datetime", categories: ["2019-09-18T00:00:00", "2019-09-18T01:00:00", "2019-09-18T02:00:00", "2019-09-18T03:00:00", "2019-09-18T04:00:00", "2019-09-18T05:00:00", "2019-09-18T06:00:00"]
        }
        , tooltip: {
            x: {
    ...
    var o= {
        ...
        , series:[ {
            ...
            categories: ["South Korea", "Canada", "United Kingdom", "Netherlands", "Italy", "France", "Japan", "United States", "China", "Germany"], tickAmount: 5
        }
    }
    ;
    ...
    var i= {
        chart: {
            height: 350, type: "line", stacked: !1
        }
        , colors:t, stroke: {
        ...
        , {
            ...
            opacity:[.85, .25, 1], gradient: {
                inverseColors: !1, shade: "light", type: "vertical", opacityFrom: .85, opacityTo: .55, stops: [0, 100, 100, 100]
            }
        }
        , labels:["01/01/2003", "02/01/2003", "03/01/2003", "04/01/2003", "05/01/2003", "06/01/2003", "07/01/2003", "08/01/2003", "09/01/2003", "10/01/2003", "11/01/2003"], markers: {
            size: 0
        }
        , legend: {
            offsetY: -10
    ...
    function d(e, t, a) {
        ...
        n<t;
            ...
            var o=Math.floor(Math.random()*(a.max-a.min+1))+a.min, i=Math.floor(61*Math.random())+15;
    ...
    var c= {
        ...
        , series:[ {
            name:"Product1", data:d(new Date("11 Feb 2017 GMT").getTime(), 20, {
                min: 10, max: 60
            }
            )
        }
        , {
            name:"Product2", data:d(new Date("11 Feb 2017 GMT").getTime(), 20, {
                min: 10, max: 60
            }
            )
        }
        , {
            name:"Product3", data:d(new Date("11 Feb 2017 GMT").getTime(), 20, {
                min: 10, max: 60
            }
            )
        }
        , {
            name:"Product4", data:d(new Date("11 Feb 2017 GMT").getTime(), 20, {
                min: 10, max: 60
            }
            )
        }
        ...
        , xaxis: {
            tickAmount:12, type:"datetime", labels: {
                rotate: 0
            }
        }
        , yaxis: {
    ...
    var l= {
        ...
        , colors:t, series:[ {
            name: "SAMPLE A", data: [[16.4, 5.4], [21.7, 2], [25.4, 3], [19, 2], [10.9, 1], [13.6, 3.2], [10.9, 7.4], [10.9, 0], [10.9, 8.2], [16.4, 0], [16.4, 1.8], [13.6, .3], [13.6, 0], [29.9, 0], [27.1, 2.3], [16.4, 0], [13.6, 3.7], [10.9, 5.2], [16.4, 6.5], [10.9, 0], [24.5, 7.1], [10.9, 0], [8.1, 4.7], [19, 0], [21.7, 1.8], [27.1, 0], [24.5, 0], [27.1, 0], [29.9, 1.5], [27.1, .8], [22.1, 2]]
        }
        , {
            name: "SAMPLE B", data: [[6.4, 13.4], [1.7, 11], [5.4, 8], [9, 17], [1.9, 4], [3.6, 12.2], [1.9, 14.4], [1.9, 9], [1.9, 13.2], [1.4, 7], [6.4, 8.8], [3.6, 4.3], [1.6, 10], [9.9, 2], [7.1, 15], [1.4, 0], [3.6, 13.7], [1.9, 15.2], [6.4, 16.5], [.9, 10], [4.5, 17.1], [10.9, 10], [.1, 14.7], [9, 10], [12.7, 11.8], [2.1, 10], [2.5, 10], [27.1, 10], [2.9, 11.5], [7.1, 10.8], [2.1, 12]]
        }
        , {
            name: "SAMPLE C", data: [[21.7, 3], [23.6, 3.5], [24.6, 3], [29.9, 3], [21.7, 20], [23, 2], [10.9, 3], [28, 4], [27.1, .3], [16.4, 4], [13.6, 0], [19, 5], [22.4, 3], [24.5, 3], [32.6, 3], [27.1, 4], [29.6, 6], [31.6, 8], [21.6, 5], [20.9, 4], [22.4, 0], [32.6, 10.3], [29.7, 20.8], [24.5, .8], [21.4, 0], [21.7, 6.9], [28.6, 7.7], [15.4, 0], [18.1, 0], [33.4, 0], [16.4, 0]]
        }
        ], legend: {
            offsetY: -10
        }
    ...
    var m= {
        ...
        , colors:t, labels:["Team A", "Team B", "Team C", "Team D"], series:[44, 55, 13, 43], legend: {
            itemMargin: {
                horizontal: 2
            }
        }
    ...
    var y= {
        ...
        , colors:t, series:[44, 55, 41, 17], legend: {
            itemMargin: {
                horizontal: 2
            }
        }
    ...
    var x= {
        ...
        , series:[44, 55, 67, 83], labels:["Apples", "Oranges", "Bananas", "Berries"]
    }
    ;
    ...
    var h= {
        ...
        ], labels:["January", "February", "March", "April", "May", "June"], dataLabels: {
            style: {
                color: "#E6EAEE"
            }
        }
    ...
    function w(e, t) {
        ...
        a<e;
            ...
            var r="w"+(a+1).toString(), o=Math.floor(Math.random()*(t.max-t.min+1))+t.min;
            n.push( {
                x: r, y: o
            }
            ), a++
    ...
    var p= {
        ...
        , colors:[e], series:[ {
            name:"Metric1", data:w(18, {
                min: 0, max: 90
            }
            )
        }
        , {
            name:"Metric2", data:w(18, {
                min: 0, max: 90
            }
            )
        }
        , {
            name:"Metric3", data:w(18, {
                min: 0, max: 90
            }
            )
        }
        , {
            name:"Metric4", data:w(18, {
                min: 0, max: 90
            }
            )
        }
        , {
            name:"Metric5", data:w(18, {
                min: 0, max: 90
            }
            )
        }
        , {
            name:"Metric6", data:w(18, {
                min: 0, max: 90
            }
            )
        }
        , {
            name:"Metric7", data:w(18, {
                min: 0, max: 90
            }
            )
        }
        , {
            name:"Metric8", data:w(18, {
                min: 0, max: 90
            }
            )
        }
        , {
            name:"Metric9", data:w(18, {
                min: 0, max: 90
            }
            )
        }
